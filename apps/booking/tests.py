...
class SelectDateTest(TestCase):
    ...
    def test_invalid_date_format(self):
        ...
        response = self.client.post(
            self.url,
            {"selected_stylist_id": self.stylist.id, "date-calendar": "invalid_date"},
        )
        self.assertRedirects(response, reverse("booking"))
...
class BookAppointmentTest(TestCase):
    ...
    def test_book_appointment_success(self):
        ...
        self.assertRedirects(
            response, reverse("booking_confirmation", kwargs={"booking_id": 1})
        )
...
class BookAppointmentTest(TestCase):
    ...
    def setUp(self):
        ...
        self.stylist = Stylist.objects.create(
            name="Test Stylist", bio="Experienced stylist"
        )  # Create a stylist
    ...
    def test_book_appointment_success(self):
        ...
        booking = Booking.objects.create(
            ...
            # Assuming your booking model has a foreign key to UserProfile
        )
...
class BookingConfirmationTest(TestCase):
    ...
    def setUp(self):
        ...
        self.service = Service.objects.create(
            title="Test Service", price=100.0
        )  # Define price
        self.stylist = Stylist.objects.create(
            name="Test Stylist", bio="Experienced stylist"
        )
