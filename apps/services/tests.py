...
class ServicesViewsTests(TestCase):
    ...
    def setUp(self):
        ...
        Service.objects.create(
            title="Serviço 1"
        )  # Create a Service instance with title "Serviço 1"
        Service.objects.create(
            title="Serviço 2"
        )  # Create a Service instance with title "Serviço 2"
    ...
    def test_home_view(self):
        ...
        self.assertTemplateUsed(
            response, "services/index.html"
        )  # Verify that the template used is 'services/index.html'
    ...
    def test_services_view(self):
        ...
        self.assertTemplateUsed(
            response, "services/services.html"
        )  # Verify that the template used is 'services/services.html'
        self.assertContains(
            response, "Serviço 1"
        )  # Check that the expected content ("Serviço 1") is in the response
